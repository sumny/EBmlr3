...
LearnerRegrEBM = R6Class("LearnerRegrEBM",
  ...
  private = list(
    .train = function(task) {
      ...
      model = reticulate::py$ExplainableBoostingRegressor(max_bins = pv$max_bins, max_interaction_bins = pv$max_interaction_bins, binning = pv$binning, mains = pv$mains, interactions = pv$interactions,
